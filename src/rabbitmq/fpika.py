...
class Pika(object):
    ...
    def init_app(self, app):
        ...
        """
        pika_params = FLASK_PIKA_PARAMS # app.config['FLASK_PIKA_PARAMS']
        pool_params = FLASK_PIKA_POOL_PARAMS # app.config.get('FLASK_PIKA_POOL_PARAMS', None)

        self.debug = None # app.debug
        self.logger = None # app.logger
        self.pool_size = 1
        self.pool_recycle = -1
